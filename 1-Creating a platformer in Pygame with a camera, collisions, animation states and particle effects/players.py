...
class Player(pygame.sprite.Sprite):
    ...
    def import_dust_run_particles(self):
        self.dust_run_particles = import_folder('../RESOURCES/1 - Basic platformer/graphics/character/dust_particles/run')
    ...
    def run_dust_animation(self):
        if self.status == 'run' and self.on_ground:
            ...
            if self.facing_right:
                pos = self.rect.bottomleft -pygame.math.Vector2(6,10) # values set experimenting
                self.display_surface.blit(dust_particle,pos)
            else:
                pos = self.rect.bottomright - pygame.math.Vector2(6, 10)  # values set experimenting
